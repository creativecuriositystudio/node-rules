(function() {
    ...
    var compileValue = function (facts, value) {
        ...
        case '$avgOf':
            ...
            case '$sumOf': return [true, value.reduce((a, b) => a + b, 0)];
            case '$avgOf': return [true, value.length ? value.reduce((a, b) => a + b) / value.length : null];
            }
        }
    ...
    var checkConditions = function (facts, conds, isAnd) {
        ...
        return _[isAnd ? 'all' : 'any'](_.pairs(conds), function (pair, i) {
            ...
            var fact = key ? dig(facts, key) : facts;
            ...
            if (!_.isUndefined(reducer)) {
                ...
                case 'sum': fact = fact.reduce((a, b) => a + b, 0); break;
                case 'avg': fact = fact.length ? fact.reduce((a, b) => a + b, 0) / fact.length : null; break;
