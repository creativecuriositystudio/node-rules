(function() {
    ...
    var bury = function (obj, properties, value) {
        ...
        return _.reduce(properties.split('.'), function (memo, prop, i, parts) {
            ...
            return _.isObject(memo) ? memo[prop] : (memo[prop] = {});
        }, obj);
    };
    ...
    var testFact = function (facts, key, operations) {
        ...
        return _[operations.$or ? 'any' : 'all'](operations.$or || operations.$and || operations, function (uncompiledValue, key) {
            ...
            case '$matches': return !!fact.match(value);
            case '$notMatches': return !fact.match(value);
            case '$has': return fact.includes(value);
            case '$notHas': return !fact.includes(value);
    ...
    var checkConditions = function (facts, conditions, isAnd) {
        if (_.isArray(conditions)) {
            return _[isAnd ? 'all' : 'any'](conditions, function (subConds, i) {
    ...
    var doConsequences = function (facts, consequences) {
        _.each(consequences, function (subCons, key) {
            if (_.isArray(consequences)) doConsequences(facts, subCons);
                    ...
                    if (outcome) {
                        ...
                        process.nextTick(function() {
                            ...
                            if (_.isFunction(_consequence))
                                ...
                                doConsequences(session, _consequence);
                                API.stop();
                            }
                        });
                    } else {
